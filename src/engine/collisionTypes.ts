...
const GROUP_WALL = [WALL, WALL2, WALLOOB, RR_SPECIAL_WALL, KNOCKBACK_DAMAGE];

const GROUP_BOOST = [BOOST, BOOST2, LOOP];

const GROUP_OOB = [OOB, FALL];
...
const SOUNDMAP = {
	...
	0x00: [
		...
		{
			drift: MKDS_COLSOUNDS.DRIFT_SAND,
			brake: MKDS_COLSOUNDS.BRAKE_SAND,
			land: MKDS_COLSOUNDS.LAND_SAND,
			drive: MKDS_COLSOUNDS.DRIVE_SAND,
		},
		{
			drift: MKDS_COLSOUNDS.DRIFT_STONE,
			brake: MKDS_COLSOUNDS.BRAKE_STONE,
			land: MKDS_COLSOUNDS.LAND_ASPHALT,
			drive: MKDS_COLSOUNDS.DRIVE_STONE,
		},
	...
	0x01: [
		...
		{ drift: MKDS_COLSOUNDS.DRIFT_ASPHALT, brake: MKDS_COLSOUNDS.BRAKE, land: MKDS_COLSOUNDS.LAND_ASPHALT },
		{
			drift: MKDS_COLSOUNDS.DRIFT_WATER,
			brake: MKDS_COLSOUNDS.BRAKE_WATER,
			land: MKDS_COLSOUNDS.LAND_WATERDEEP,
			drive: MKDS_COLSOUNDS.DRIVE_WATER,
			particle: 30,
		},
		{ drift: MKDS_COLSOUNDS.DRIFT_ASPHALT, brake: MKDS_COLSOUNDS.BRAKE, land: MKDS_COLSOUNDS.LAND_ASPHALT },
	...
	0x03: [
		...
		{
			drift: MKDS_COLSOUNDS.DRIFT_DIRT,
			brake: MKDS_COLSOUNDS.BRAKE_DIRT,
			land: MKDS_COLSOUNDS.LAND_DIRT,
			drive: MKDS_COLSOUNDS.DRIVE_DIRT,
			particle: 15,
		},

		{
			drift: MKDS_COLSOUNDS.DRIFT_ASPHALT,
			brake: MKDS_COLSOUNDS.BRAKE,
			land: MKDS_COLSOUNDS.LAND_GRASS,
			drive: MKDS_COLSOUNDS.DRIVE_GRASS,
			particle: 32,
		},
	...
	0x06: [
		...
		{
			drift: MKDS_COLSOUNDS.DRIFT_MARSH,
			brake: MKDS_COLSOUNDS.BRAKE_MARSH,
			land: MKDS_COLSOUNDS.LAND_MARSH,
			drive: MKDS_COLSOUNDS.DRIVE_MARSH,
			particle: 24,
		},
		{},
		{},
	...
	//wall oob
	0x10: [{ hit: MKDS_COLSOUNDS.HIT_CONCRETE }, {}, {}, {}, {}, {}, {}, {}],

	//wall with sound effect
	0x15: [
		{ hit: MKDS_COLSOUNDS.HIT_CONCRETE },
		{ hit: MKDS_COLSOUNDS.HIT_STONE },
	...
	0x14: [
		{},
		{
			drift: MKDS_COLSOUNDS.DRIFT_CARPET,
			brake: MKDS_COLSOUNDS.BRAKE_CARPET,
			land: MKDS_COLSOUNDS.LAND_CARPET,
			drive: MKDS_COLSOUNDS.DRIVE_CARPET,
		},
		{ drift: MKDS_COLSOUNDS.DRIFT_RAINBOW, brake: MKDS_COLSOUNDS.BRAKE_RAINBOW, land: MKDS_COLSOUNDS.LAND_ASPHALT },
		{},
		{}, //stairs
