...
export class ncgr implements MKJSDataFormator {
	...
	private _loadCHAR(view: DataView): NcgrChar {
		...
		let tileCount = (blockSize - 0x20) / (bitDepth == 4 ? 64 : 32);
	...
	private _loadCPOS(view: DataView): NcgrCpos {
